...
funcion return<-costoEquipaje(opcionesEquipaje, iva Por Referencia, arrayEquipajesGuardados,costoFinalEquipaje por referencia)
	...
	arrayEquipajesGuardados[cantidadReservas,2]<- ConvertirATexto(costoFinalEquipaje)
...
SubProceso mostrarArray(reservasCompra,n,m)
	...
	Para i<-0 Hasta n-1 Hacer
		Para j<-0 Hasta m-1 Hacer
			Escribir Sin Saltar reservasCompra[i,j] "   "
		Fin Para
		Escribir ""
	Fin Para
FinSubProceso
